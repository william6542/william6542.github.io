...
In addition monetary ROI, the public library also generates ROI indirectly through these avenues:  
...
Each of these non-monetary values are not easily measured, but have the potential to indirectly create big monetary ROI. For example, if a marginalized young person, such as a gay student, is inspired by browsing in the stacks, or feels like a book speaks to them, that will be much [better for their mental health and self-image](https://www.ifla.org/files/assets/hq/topics/libraries-development/documents/how_libraries_provide_safe_spaces_to_all_youth.pdf), than if said student continued to feel isolated and denied information which represented who they are. In other words, people with mental health problems are not effective produces in society, and require more state resources to help them resolve their issues. 

To state another example, by providing public rooms for community members to meet, there is the potential for innovation and new community groups to spring up. Simply by facilitating the free space, public libraries can encourage community contact and growth spontaneously. The more a people trust and know each other, the more likely they are going to visit each other's businesses, create new start ups, help each other in time of need, and so on. 

There are [numerous studies by the Library Research Service](https://www.lrs.org/?s=investment) (a department of the Colorado State Library) which indicate the great value of public libraries. 
